...
module Google
  module Compute
    module Data
      ...
      # Imports name from zone
      class ZoneNameRef
        include Comparable

        def ==(other)
          return false unless other.is_a? ZoneNameRef
      ...
      class ZoneNameRefCatalog < ZoneNameRef
      ...
      class ZoneNameRefApi < ZoneNameRef
    ...
    module Property
      # A class to manage fetching name from a zone
      class ZoneNameRef
        def self.coerce
          ->(parent_resource, value) { ::Google::Compute::Property::ZoneNameRef.catalog_parse(value, parent_resource) }
        end
        ...
        def self.catalog_parse(value, parent_resource = nil)
          return if value.nil?
          return value if value.is_a? Data::ZoneNameRef
          Data::ZoneNameRefCatalog.new(value, parent_resource)
        end
