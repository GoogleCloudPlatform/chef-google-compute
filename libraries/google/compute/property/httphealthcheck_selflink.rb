...
module Google
  module Compute
    ...
    module Property
      ...
      class HttpHealthCheckSelfLinkRef
        def self.coerce
          ->(parent_resource, value) { ::Google::Compute::Property::HttpHealthCheckSelfLinkRef.catalog_parse(value, parent_resource) }
        end
        ...
        def self.catalog_parse(value, parent_resource = nil)
          ...
          Data::HttpHealthCheckSelfLinkRefCatalog.new(value, parent_resource)
        end
