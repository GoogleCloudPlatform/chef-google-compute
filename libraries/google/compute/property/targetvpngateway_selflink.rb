...
module Google
  module Compute
    module Data
      ...
      # Imports self_link from target_vpn_gateway
      class TargetVpnGatewaySelfLinkRef
        include Comparable

        def ==(other)
          return false unless other.is_a? TargetVpnGatewaySelfLinkRef
      ...
      class TargetVpnGatewaySelfLinkRefCatalog < TargetVpnGatewaySelfLinkRef
        ...
        def resource
          ...
          raise ArgumentError, "gcompute_target_vpn_gateway[#{@title}] required"
        end
      end

      # A class to manage a JSON blob from GCP API
      # Will immediately return value from JSON blob without changes
      class TargetVpnGatewaySelfLinkRefApi < TargetVpnGatewaySelfLinkRef
    ...
    module Property
      # A class to manage fetching self_link from a target_vpn_gateway
      class TargetVpnGatewaySelfLinkRef
        def self.coerce
          ->(parent_resource, value) { ::Google::Compute::Property::TargetVpnGatewaySelfLinkRef.catalog_parse(value, parent_resource) }
        end
        ...
        def self.catalog_parse(value, parent_resource = nil)
          return if value.nil?
          return value if value.is_a? Data::TargetVpnGatewaySelfLinkRef
          Data::TargetVpnGatewaySelfLinkRefCatalog.new(value, parent_resource)
        end
        ...
        def self.api_parse(value)
          return if value.nil?
          return value if value.is_a? Data::TargetVpnGatewaySelfLinkRef
          Data::TargetVpnGatewaySelfLinkRefApi.new(value)
        end
      end
    end
  end
