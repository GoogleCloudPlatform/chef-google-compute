...
module Google
  module Compute
    module Data
      ...
      class TarVpnGatSelLinRef
        include Comparable

        def ==(other)
          return false unless other.is_a? TarVpnGatSelLinRef
      ...
      class TarVpnGatSelLinRefCatalog < TarVpnGatSelLinRef
      ...
      class TarVpnGatSelLinRefApi < TarVpnGatSelLinRef
    ...
    module Property
      ...
      class TarVpnGatSelLinRef
        def self.coerce
          ->(x) { ::Google::Compute::Property::TarVpnGatSelLinRef.catalog_parse(x) }
        end
        ...
        def self.catalog_parse(value)
          return if value.nil?
          return value if value.is_a? Data::TarVpnGatSelLinRef
          Data::TarVpnGatSelLinRefCatalog.new(value)
        end
        ...
        def self.api_parse(value)
          return if value.nil?
          return value if value.is_a? Data::TarVpnGatSelLinRef
          Data::TarVpnGatSelLinRefApi.new(value)
        end
      end
    end
  end
