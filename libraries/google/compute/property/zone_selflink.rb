    ...
    module Data
      ...
      class ZoneSelfLinkRefCatalog < ZoneSelfLinkRef
        ...
        def resource
          ...
          unless /https:\/\/www.googleapis.com\/compute\/v1\/projects\/.*\/zones\/[a-z1-9\-]*/.match(@title)
            ...
            return "https://www.googleapis.com/compute/v1/projects/#{@parent_resource.project}/zones/#{@title}"
          end
          @title
        end
      end
