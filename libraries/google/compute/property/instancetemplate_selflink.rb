...
module Google
  module Compute
    module Data
      ...
      # Imports self_link from instance_template
      class InstanceTemplateSelfLinkRef
        include Comparable

        def ==(other)
          return false unless other.is_a? InstanceTemplateSelfLinkRef
      ...
      class InstanceTemplateSelfLinkRefCatalog < InstanceTemplateSelfLinkRef
        ...
        def resource
          ...
          raise ArgumentError, "gcompute_instance_template[#{@title}] required"
        end
      end

      # A class to manage a JSON blob from GCP API
      # Will immediately return value from JSON blob without changes
      class InstanceTemplateSelfLinkRefApi < InstanceTemplateSelfLinkRef
    ...
    module Property
      # A class to manage fetching self_link from a instance_template
      class InstanceTemplateSelfLinkRef
        def self.coerce
          ->(parent_resource, value) { ::Google::Compute::Property::InstanceTemplateSelfLinkRef.catalog_parse(value, parent_resource) }
        end
        ...
        def self.catalog_parse(value, parent_resource = nil)
          return if value.nil?
          return value if value.is_a? Data::InstanceTemplateSelfLinkRef
          Data::InstanceTemplateSelfLinkRefCatalog.new(value, parent_resource)
        end
        ...
        def self.api_parse(value)
          return if value.nil?
          return value if value.is_a? Data::InstanceTemplateSelfLinkRef
          Data::InstanceTemplateSelfLinkRefApi.new(value)
        end
      end
    end
  end
