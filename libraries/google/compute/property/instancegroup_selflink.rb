...
module Google
  module Compute
    module Data
      ...
      class InstanceGroupSelfLinkRef
        include Comparable

        def ==(other)
          return false unless other.is_a? InstanceGroupSelfLinkRef
      ...
      class InstanceGroupSelfLinkRefCatalog < InstanceGroupSelfLinkRef
      ...
      class InstanceGroupSelfLinkRefApi < InstanceGroupSelfLinkRef
    ...
    module Property
      ...
      class InstanceGroupSelfLinkRef
        def self.coerce
          ->(parent_resource, value) { ::Google::Compute::Property::InstanceGroupSelfLinkRef.catalog_parse(value, parent_resource) }
        end
        ...
        def self.catalog_parse(value, parent_resource = nil)
          return if value.nil?
          return value if value.is_a? Data::InstanceGroupSelfLinkRef
          Data::InstanceGroupSelfLinkRefCatalog.new(value, parent_resource)
        end
        ...
        def self.api_parse(value)
          return if value.nil?
          return value if value.is_a? Data::InstanceGroupSelfLinkRef
          Data::InstanceGroupSelfLinkRefApi.new(value)
        end
      end
    end
  end
