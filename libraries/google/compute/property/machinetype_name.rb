...
module Google
  module Compute
    ...
    module Property
      ...
      class MachineTypeNameRef
        def self.coerce
          ->(parent_resource, value) { ::Google::Compute::Property::MachineTypeNameRef.catalog_parse(value, parent_resource) }
        end
        ...
        def self.catalog_parse(value, parent_resource = nil)
          ...
          Data::MachineTypeNameRefCatalog.new(value, parent_resource)
        end
