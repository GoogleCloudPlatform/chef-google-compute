...
module Google
  module Compute
    module Data
      ...
      # Imports self_link from disk
      class DiskSelfLinkRef
        include Comparable

        def ==(other)
          return false unless other.is_a? DiskSelfLinkRef
      ...
      class DiskSelfLinkRefCatalog < DiskSelfLinkRef
      ...
      class DiskSelfLinkRefApi < DiskSelfLinkRef
    ...
    module Property
      # A class to manage fetching self_link from a disk
      class DiskSelfLinkRef
        def self.coerce
          ->(parent_resource, value) { ::Google::Compute::Property::DiskSelfLinkRef.catalog_parse(value, parent_resource) }
        end
        ...
        def self.catalog_parse(value, parent_resource = nil)
          return if value.nil?
          return value if value.is_a? Data::DiskSelfLinkRef
          Data::DiskSelfLinkRefCatalog.new(value, parent_resource)
        end
        ...
        def self.api_parse(value)
          return if value.nil?
          return value if value.is_a? Data::DiskSelfLinkRef
          Data::DiskSelfLinkRefApi.new(value)
        end
      end
    end
  end
