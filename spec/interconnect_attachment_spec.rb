...
context 'gcompute_interconnect_attachment' do
          ...
          context 'title == name (pass)' do
            ...
            let(:runner) do
              ...
              ChefSpec::SoloRunner.new(
                step_into: %w[gcompute_interconnect_attachment gcompute_region gcompute_network
                              gcompute_router],
            ...
            let(:chef_run) do
              apply_recipe(
                <<-MANIFEST
                  ...
                  gcompute_interconnect_attachment 'title0' do
                    action :create
                  ...
                  gcompute_interconnect_attachment 'title1' do
                    action :create
                  ...
                  gcompute_interconnect_attachment 'title2' do
                    action :create
            ...
            context 'gcompute_interconnect_attachment[title0]' do
              subject do
                chef_run.find_resource(:gcompute_interconnect_attachment, 'title0')
              end
              ...
              it { is_expected.to have_attributes(ia_label: 'title0') }
            ...
            context 'gcompute_interconnect_attachment[title1]' do
              subject do
                chef_run.find_resource(:gcompute_interconnect_attachment, 'title1')
              end
              ...
              it { is_expected.to have_attributes(ia_label: 'title1') }
            ...
            context 'gcompute_interconnect_attachment[title2]' do
              subject do
                chef_run.find_resource(:gcompute_interconnect_attachment, 'title2')
              end
              ...
              it { is_expected.to have_attributes(ia_label: 'title2') }
        ...
        context 'title != name' do
          ...
          context 'title != name (pass)' do
            ...
            context 'gcompute_interconnect_attachment[title0]' do
              ...
              it { is_expected.to have_attributes(ia_label: 'test name#0 data') }
            ...
            context 'gcompute_interconnect_attachment[title1]' do
              ...
              it { is_expected.to have_attributes(ia_label: 'test name#1 data') }
            ...
            context 'gcompute_interconnect_attachment[title2]' do
              ...
              it { is_expected.to have_attributes(ia_label: 'test name#2 data') }
      ...
      context 'title == name' do
        ...
        context 'title == name (pass)' do
          ...
          it 'should run test correctly' do
            expect(chef_run).to create(:gcompute_interconnect_attachment,
                                       'title0')
          end
          it { is_expected.to have_attributes(interconnect: 'test interconnect#0 data') }
    ...
    context 'resource exists' do
      ...
      context 'title == name' do
        ...
        context 'title == name (pass)' do
          ...
          it 'should run test correctly' do
            expect(chef_run).to delete(:gcompute_interconnect_attachment,
                                       'title0')
          end
        end
  ...
  def expand_variables(template, data, extra_data = {})
    Google::GCOMPUTE::InterconnectAttachment
