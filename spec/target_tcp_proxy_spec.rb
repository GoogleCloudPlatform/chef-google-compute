...
context 'gcompute_target_tcp_proxy' do
          ...
          context 'title == name (pass)' do
            ...
            let(:runner) do
              ...
              ChefSpec::SoloRunner.new(
                step_into: %w[gcompute_target_tcp_proxy gcompute_backend_service],
            ...
            let(:chef_run) do
              apply_recipe(
                <<-MANIFEST
                  ...
                  gcompute_target_tcp_proxy 'title0' do
                    action :create
                  ...
                  gcompute_target_tcp_proxy 'title1' do
                    action :create
                  ...
                  gcompute_target_tcp_proxy 'title2' do
                    action :create
            ...
            context 'gcompute_target_tcp_proxy[title0]' do
              subject do
            ...
            context 'gcompute_target_tcp_proxy[title1]' do
              subject do
            ...
            context 'gcompute_target_tcp_proxy[title2]' do
              subject do
    ...
    context 'resource exists' do
      ...
      context 'title == name' do
        ...
        context 'title == name (pass)' do
          ...
          it 'should run test correctly' do
            expect(chef_run).to delete(:gcompute_target_tcp_proxy,
                                       'title0')
          end
        end
  ...
  def expand_variables(template, data, extra_data = {})
    Google::GCOMPUTE::TargetTcpProxy
  ...
  def expect_network_get_async(id, data = {})
    body = { kind: 'compute#targetTcpProxy' }.to_json
  ...
  def load_network_result(file)
    results = File.join(File.dirname(__FILE__), 'data', 'network',
                        'gcompute_target_tcp_proxy', file)
  ...
  def uri_data(id)
    {
      project: GoogleTests::Constants::TTP_PROJECT_DATA[(id - 1) \
        % GoogleTests::Constants::TTP_PROJECT_DATA.size],
      name: GoogleTests::Constants::TTP_NAME_DATA[(id - 1) \
        % GoogleTests::Constants::TTP_NAME_DATA.size]
    }
  end
