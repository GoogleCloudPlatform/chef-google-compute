...
context 'gcompute_instance_template' do
          ...
          context 'title == name (pass)' do
            ...
            let(:runner) do
              ...
              ChefSpec::SoloRunner.new(
                step_into: %w[gcompute_instance_template
                              gcompute_region
                              gcompute_subnetwork
                              gcompute_network
                              gcompute_address
            ...
            let(:chef_run) do
              apply_recipe(
                <<-MANIFEST
                  ...
                  gcompute_instance_template 'title0' do
                    action :create
                  ...
                  gcompute_instance_template 'title1' do
                    action :create
                  ...
                  gcompute_instance_template 'title2' do
                    action :create
            ...
            context 'gcompute_instance_template[title0]' do
              subject do
            ...
            context 'gcompute_instance_template[title1]' do
              subject do
            ...
            context 'gcompute_instance_template[title2]' do
              subject do
    ...
    context 'resource exists' do
      ...
      context 'title == name' do
        ...
        context 'title == name (pass)' do
          ...
          it 'should run test correctly' do
            expect(chef_run).to delete(:gcompute_instance_template,
                                       'title0')
          end
        end
  ...
  def expect_network_get_async(id, data = {})
    body = { kind: 'compute#instanceTemplate' }.to_json
