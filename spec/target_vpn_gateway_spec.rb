...
context 'gcompute_target_vpn_gateway' do
          ...
          context 'title == name (pass)' do
            ...
            let(:runner) do
              ...
              ChefSpec::SoloRunner.new(
                step_into: %w[gcompute_target_vpn_gateway gcompute_region gcompute_forwarding_rule
                              gcompute_network],
            ...
            let(:chef_run) do
              apply_recipe(
                <<-MANIFEST
                  ...
                  gcompute_target_vpn_gateway 'title0' do
                    action :create
                  ...
                  gcompute_target_vpn_gateway 'title1' do
                    action :create
                  ...
                  gcompute_target_vpn_gateway 'title2' do
                    action :create
            ...
            context 'gcompute_target_vpn_gateway[title0]' do
              subject do
                chef_run.find_resource(:gcompute_target_vpn_gateway, 'title0')
              end

              it { is_expected.to have_attributes(description: 'test description#0 data') }

              it { is_expected.to have_attributes(tvg_label: 'title0') }
            ...
            context 'gcompute_target_vpn_gateway[title1]' do
              subject do
                chef_run.find_resource(:gcompute_target_vpn_gateway, 'title1')
              end

              it { is_expected.to have_attributes(description: 'test description#1 data') }

              it { is_expected.to have_attributes(tvg_label: 'title1') }
            ...
            context 'gcompute_target_vpn_gateway[title2]' do
              subject do
                chef_run.find_resource(:gcompute_target_vpn_gateway, 'title2')
              end

              it { is_expected.to have_attributes(description: 'test description#2 data') }

              it { is_expected.to have_attributes(tvg_label: 'title2') }
        ...
        context 'title != name' do
          ...
          context 'title != name (pass)' do
            ...
            context 'gcompute_target_vpn_gateway[title0]' do
              ...
              it { is_expected.to have_attributes(tvg_label: 'test name#0 data') }
            ...
            context 'gcompute_target_vpn_gateway[title1]' do
              ...
              it { is_expected.to have_attributes(tvg_label: 'test name#1 data') }
            ...
            context 'gcompute_target_vpn_gateway[title2]' do
              ...
              it { is_expected.to have_attributes(tvg_label: 'test name#2 data') }
      ...
      context 'title == name' do
        ...
        context 'title == name (pass)' do
          ...
          it 'should run test correctly' do
            expect(chef_run).to create(:gcompute_target_vpn_gateway,
                                       'title0')
          end
          it { is_expected.to have_attributes(description: 'test description#0 data') }
    ...
    context 'resource exists' do
      ...
      context 'title == name' do
        ...
        context 'title == name (pass)' do
          ...
          it 'should run test correctly' do
            expect(chef_run).to delete(:gcompute_target_vpn_gateway,
                                       'title0')
          end
        end
  ...
  def expand_variables_forwarding_rule(template, data, ext_dat = {})
    Google::GCOMPUTE::ForwardingRule
      .action_class.expand_variables(template, data, ext_dat)
  end
