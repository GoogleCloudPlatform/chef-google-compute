...
context 'gcompute_firewall' do
      ...
      context 'no changes == no action' do
        ...
        context 'title == name' do
          ...
          context 'title == name (pass)' do
            ...
            context 'gcompute_firewall[title0]' do
              subject do
                chef_run.find_resource(:gcompute_firewall, 'title0')
              end
            ...
            context 'gcompute_firewall[title1]' do
              subject do
                chef_run.find_resource(:gcompute_firewall, 'title1')
              end
            ...
            context 'gcompute_firewall[title2]' do
              subject do
                chef_run.find_resource(:gcompute_firewall, 'title2')
              end
      ...
      context 'title == name' do
        ...
        context 'title == name (pass)' do
          ...
          it 'should run test correctly' do
            expect(chef_run).to create(:gcompute_firewall,
                                       'title0')
          end
          # TODO(nelsonjr): Implement complex array object test.
          # it 'allowed' do
    ...
    context 'resource exists' do
      ...
      context 'title == name' do
        ...
        context 'title == name (pass)' do
          ...
          it 'should run test correctly' do
            expect(chef_run).to delete(:gcompute_firewall,
                                       'title0')
          end
        end
  ...
  def expect_network_get_async(id, data = {})
    body = { kind: 'compute#firewall' }.to_json
  ...
  def uri_data(id)
    {
      ...
      name: GoogleTests::Constants::F_NAME_DATA[(id - 1) \
        % GoogleTests::Constants::F_NAME_DATA.size]
    }
  end
