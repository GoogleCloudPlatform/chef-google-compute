...
context 'gcompute_target_pool' do
        ...
        context 'title == name' do
          ...
          context 'title == name (pass)' do
            before do
              ...
              expect_network_get_success_instance 2, zone: 'test name#1 data'
              expect_network_get_success_instance 3, zone: 'test name#2 data'
            ...
            let(:chef_run) do
              apply_recipe(
                <<-MANIFEST
                  ...
                  gcompute_instance 'resource(instance,0)' do
                    action :create
                  ...
                  gcompute_instance 'resource(instance,1)' do
                    action :create
                  ...
                  gcompute_instance 'resource(instance,2)' do
                    action :create
                  ...
                  gcompute_target_pool 'title0' do
                    action :create
                    backup_pool 'resource(target_pool,0)'
                  ...
                  gcompute_target_pool 'title1' do
                    action :create
                    backup_pool 'resource(target_pool,1)'
                  ...
                  gcompute_target_pool 'title2' do
                    action :create
                    backup_pool 'resource(target_pool,2)'
            ...
            context 'gcompute_target_pool[title0]', broken: true do
              pending('Implement tests where object references its own type')
            end

            context 'gcompute_target_pool[title1]', broken: true do
              pending('Implement tests where object references its own type')
            end

            context 'gcompute_target_pool[title2]', broken: true do
              pending('Implement tests where object references its own type')
            end
          end
    ...
    context 'resource missing' do
      ...
      context 'title == name' do
        ...
        context 'title == name (pass)' do
          before do
            ...
            expect_network_create \
              1,
              {
                ...
                'backupPool' => 'selflink(resource(target_pool,0))',
                'description' => 'test description#0 data',
          ...
          subject do
            chef_run.find_resource(:gcompute_target_pool, 'title0')
          end
      ...
      context 'title == name' do
        ...
        context 'title == name (pass)' do
          ...
          it 'should run test correctly' do
            expect(chef_run).to delete(:gcompute_target_pool,
                                       'title0')
          end
        end
  ...
  def expect_network_get_async(id, data = {})
    body = { kind: 'compute#targetPool' }.to_json
