...
context 'gcompute_target_ssl_proxy' do
          ...
          context 'title == name (pass)' do
            ...
            let(:runner) do
              ...
              ChefSpec::SoloRunner.new(
                step_into: %w[gcompute_target_ssl_proxy gcompute_ssl_certificate
            ...
            let(:chef_run) do
              apply_recipe(
                <<-MANIFEST
                  ...
                  gcompute_target_ssl_proxy 'title0' do
                    action :create
                  ...
                  gcompute_target_ssl_proxy 'title1' do
                    action :create
                  ...
                  gcompute_target_ssl_proxy 'title2' do
                    action :create
            ...
            context 'gcompute_target_ssl_proxy[title0]' do
              subject do
            ...
            context 'gcompute_target_ssl_proxy[title1]' do
              subject do
            ...
            context 'gcompute_target_ssl_proxy[title2]' do
              subject do
    ...
    context 'resource exists' do
      ...
      context 'title == name' do
        ...
        context 'title == name (pass)' do
          ...
          it 'should run test correctly' do
            expect(chef_run).to delete(:gcompute_target_ssl_proxy,
                                       'title0')
          end
        end
  ...
  def expand_variables(template, data, extra_data = {})
    Google::GCOMPUTE::TargetSslProxy
  ...
  def expect_network_get_async(id, data = {})
    body = { kind: 'compute#targetSslProxy' }.to_json
  ...
  def load_network_result(file)
    results = File.join(File.dirname(__FILE__), 'data', 'network',
                        'gcompute_target_ssl_proxy', file)
  ...
  def uri_data(id)
    {
      project: GoogleTests::Constants::TSP_PROJECT_DATA[(id - 1) \
        % GoogleTests::Constants::TSP_PROJECT_DATA.size],
      name: GoogleTests::Constants::TSP_NAME_DATA[(id - 1) \
        % GoogleTests::Constants::TSP_NAME_DATA.size]
    }
  end
