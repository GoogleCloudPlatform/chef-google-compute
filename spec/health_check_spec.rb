...
context 'gcompute_health_check' do
          ...
          context 'title == name (pass)' do
            ...
            let(:runner) do
              ...
              ChefSpec::SoloRunner.new(
                step_into: 'gcompute_health_check',
            ...
            context 'gcompute_health_check[title0]' do
              subject do
              ...
              # TODO(nelsonjr): Implement complex nested property object test.
              # it 'httpsHealthCheck' do
              #   # Add test code here
              # end

              # TODO(nelsonjr): Implement complex nested property object test.
              # it 'tcpHealthCheck' do
              #   # Add test code here
              # end

              # TODO(nelsonjr): Implement complex nested property object test.
              # it 'sslHealthCheck' do
              #   # Add test code here
              # end
            end

            context 'gcompute_health_check[title1]' do
              subject do
            ...
            context 'gcompute_health_check[title2]' do
              subject do
    ...
    context 'resource exists' do
      ...
      context 'title == name' do
        ...
        context 'title == name (pass)' do
          ...
          it 'should run test correctly' do
            expect(chef_run).to delete(:gcompute_health_check,
                                       'title0')
          end
        end
  ...
  def expect_network_get_async(id, data = {})
    body = { kind: 'compute#healthCheck' }.to_json
  ...
  def uri_data(id)
    {
      project: GoogleTests::Constants::HC_PROJECT_DATA[(id - 1) \
        % GoogleTests::Constants::HC_PROJECT_DATA.size],
      name: GoogleTests::Constants::HC_NAME_DATA[(id - 1) \
        % GoogleTests::Constants::HC_NAME_DATA.size]
    }
  end
