...
context 'gcompute_target_http_proxy' do
      ...
      context 'no changes == no action' do
        ...
        context 'title == name' do
          ...
          context 'title == name (pass)' do
            ...
            let(:chef_run) do
              apply_recipe(
                <<-MANIFEST
                  ...
                  gcompute_target_http_proxy 'title1' do
                    action :create
                  ...
                  gcompute_target_http_proxy 'title2' do
                    action :create
            ...
            context 'gcompute_target_http_proxy[title0]' do
              subject do
            ...
            context 'gcompute_target_http_proxy[title1]' do
              subject do
            ...
            context 'gcompute_target_http_proxy[title2]' do
              subject do
    ...
    context 'resource exists' do
      ...
      context 'title == name' do
        ...
        context 'title == name (pass)' do
          ...
          it 'should run test correctly' do
            expect(chef_run).to delete(:gcompute_target_http_proxy,
                                       'title0')
          end
        end
  ...
  def expand_variables(template, data, extra_data = {})
    Google::GCOMPUTE::TargetHttpProxy
  ...
  def expect_network_get_async(id, data = {})
    body = { kind: 'compute#targetHttpProxy' }.to_json
  ...
  def load_network_result(file)
    results = File.join(File.dirname(__FILE__), 'data', 'network',
                        'gcompute_target_http_proxy', file)
