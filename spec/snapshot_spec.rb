        ...
        context 'title == name' do
          ...
          context 'title == name (pass)' do
            ...
            let(:chef_run) do
              apply_recipe(
                <<-MANIFEST
                  gcompute_license 'resource(license,0)' do
                    action :create
                    l_label 'test name#0 data'
                    project 'test project#0 data'
                    credential 'mycred'
                  end

                  gcompute_license 'resource(license,1)' do
                    action :create
                    l_label 'test name#1 data'
                    project 'test project#1 data'
                    credential 'mycred'
                  end

                  gcompute_license 'resource(license,2)' do
                    action :create
                    l_label 'test name#2 data'
            ...
            context 'gcompute_snapshot[title0]' do
              subject do
                chef_run.find_resource(:gcompute_snapshot, 'title0')
              end
            ...
            context 'gcompute_snapshot[title1]' do
              subject do
                chef_run.find_resource(:gcompute_snapshot, 'title1')
              end
            ...
            context 'gcompute_snapshot[title2]' do
              subject do
                chef_run.find_resource(:gcompute_snapshot, 'title2')
              end
      ...
      context 'title == name' do
        ...
        context 'title == name (pass)' do
          ...
          it 'should run test correctly' do
            expect(chef_run).to create(:gcompute_snapshot,
                                       'title0')
          end
          it { is_expected.to have_attributes(s_label: 'title0') }
    ...
    context 'resource exists' do
      ...
      context 'title == name' do
        ...
        context 'title == name (pass)' do
          ...
          it 'should run test correctly' do
            expect(chef_run).to delete(:gcompute_snapshot,
                                       'title0')
          end
        end
