...
context 'gcompute_global_forwarding_rule' do
            ...
            let(:chef_run) do
              apply_recipe(
                <<-MANIFEST
                  ...
                  gcompute_global_forwarding_rule 'title0' do
                    action :create
                  ...
                  gcompute_global_forwarding_rule 'title1' do
                    action :create
                  ...
                  gcompute_global_forwarding_rule 'title2' do
                    action :create
    ...
    context 'resource exists' do
      ...
      context 'title == name' do
        ...
        context 'title == name (pass)' do
          ...
          it 'should run test correctly' do
            expect(chef_run).to delete(:gcompute_global_forwarding_rule,
                                       'title0')
          end
        end
  ...
  def expand_variables(template, data, extra_data = {})
    Google::GCOMPUTE::GlobalForwardingRule
