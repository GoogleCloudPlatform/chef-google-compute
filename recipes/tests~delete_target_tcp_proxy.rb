...
#       "recipe[gcompute::tests~delete_target_tcp_proxy]"
#
...
gcompute_backend_service 'chef-e2e-my-tcp-backend' do
  action :create
  backends [
...
gcompute_target_tcp_proxy 'chef-e2e-my-tcp-proxy' do
  action :delete
  proxy_header 'PROXY_V1'
  service 'chef-e2e-my-tcp-backend'
  project ENV['PROJECT'] # ex: 'my-test-project'
  credential 'mycred'
end
