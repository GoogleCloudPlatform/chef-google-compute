...
module Google
  module GCOMPUTE
    ...
    class HealthCheck < Chef::Resource
      resource_name :gcompute_health_check
      ...
      action_class do
        ...
        def self.resource_to_hash(resource)
          {
            ...
            type: resource.type,
            http_health_check: resource.http_health_check,
            https_health_check: resource.https_health_check,
            tcp_health_check: resource.tcp_health_check,
            ssl_health_check: resource.ssl_health_check
          }.reject { |_, v| v.nil? }
        end
        ...
        def wait_for_completion(status, op_result, resource)
          ...
          while status != 'DONE'
            ...
            sleep 1.0
            raise "Invalid result '#{status}' on gcompute_health_check." \
