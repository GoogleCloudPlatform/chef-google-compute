    ...
    class UrlMap < Chef::Resource
      ...
      action_class do
        def resource_to_request
          request = {
            kind: 'compute#urlMap',
            defaultService: new_resource.default_service,
            description: new_resource.description,
            hostRules: new_resource.host_rules,
            name: new_resource.um_label,
            pathMatchers: new_resource.path_matchers,
