    ...
    class SslCertificate < Chef::Resource
      ...
      action :create do
        ...
        if fetch.nil?
          ...
          @current_resource.certificate =
            ::Google::Compute::Property::String.api_parse(fetch['certificate'])
      ...
      action_class do
        ...
        def update
          converge_if_changed do |_vars|
            ...
            puts # making a newline until we find a better way TODO: find!
            compute_changes.each { |log| puts "    - #{log.strip}\n" }
            message = 'SslCertificate cannot be edited'
        ...
        def wait_for_completion(status, op_result, resource)
          ...
          while status != 'DONE'
            ...
            sleep 1.0
            raise "Invalid result '#{status}' on gcompute_ssl_certificate." \
