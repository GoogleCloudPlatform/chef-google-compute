...
module Google
  module GCOMPUTE
    ...
    class License < Chef::Resource
      resource_name :gcompute_license
      ...
      action :create do
        Chef.deprecated(:generic,
                        ["gcompute_license has been deprecated.",
        ...
        if fetch.nil?
          converge_by "Creating gcompute_license[#{new_resource.name}]" do
            ...
            @new_resource.__fetched =
              return_if_object create_req.send, 'compute#license'
          end
        else
      ...
      action :delete do
        ...
        unless fetch.nil?
          converge_by "Deleting gcompute_license[#{new_resource.name}]" do
            ...
            return_if_object delete_req.send, 'compute#license'
          end
        end
      end
