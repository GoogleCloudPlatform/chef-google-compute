      ...
      action_class do
        def resource_to_request
          request = {
            ...
            baseInstanceName: new_resource.base_instance_name,
            description: new_resource.description,
            instanceTemplate: new_resource.instance_template,
            name: new_resource.igm_label,
            namedPorts: new_resource.named_ports,
            targetPools: new_resource.target_pools,
            targetSize: new_resource.target_size
          }.reject { |_, v| v.nil? }
          request.to_json
        end
