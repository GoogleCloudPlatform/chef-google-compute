...
module Google
  module GCOMPUTE
    ...
    class InterconnectAttachment < Chef::Resource
      resource_name :gcompute_interconnect_attachment

      property :cloud_router_ip_address,
               String, coerce: ::Google::Compute::Property::String.coerce, desired_state: true
      property :customer_router_ip_address,
               String, coerce: ::Google::Compute::Property::String.coerce, desired_state: true
      ...
      action :create do
        ...
        if fetch.nil?
          converge_by "Creating gcompute_interconnect_attachment[#{new_resource.name}]" do
          ...
          @current_resource.cloud_router_ip_address =
            ::Google::Compute::Property::String.api_parse(fetch['cloudRouterIpAddress'])
          @current_resource.customer_router_ip_address =
            ::Google::Compute::Property::String.api_parse(fetch['customerRouterIpAddress'])
          @current_resource.interconnect =
            ::Google::Compute::Property::String.api_parse(fetch['interconnect'])
      ...
      action :delete do
        fetch = fetch_resource(@new_resource,
                               ...
                               'compute#interconnectAttachment')
        unless fetch.nil?
          converge_by "Deleting gcompute_interconnect_attachment[#{new_resource.name}]" do
      ...
      action_class do
        def resource_to_request
          request = {
            ...
            interconnect: new_resource.interconnect,
            description: new_resource.description,
            router: new_resource.router,
            name: new_resource.ia_label
          }.reject { |_, v| v.nil? }
          request.to_json
        end
        ...
        def update
          converge_if_changed do |_vars|
            ...
            puts # making a newline until we find a better way TODO: find!
            compute_changes.each { |log| puts "    - #{log.strip}\n" }
            message = 'InterconnectAttachment cannot be edited'
        ...
        def self.resource_to_hash(resource)
          {
            ...
            name: resource.ia_label,
            kind: 'compute#interconnectAttachment',
            cloud_router_ip_address: resource.cloud_router_ip_address,
            customer_router_ip_address: resource.customer_router_ip_address,
            interconnect: resource.interconnect,
            description: resource.description,
            private_interconnect_info: resource.private_interconnect_info,
            google_reference_id: resource.google_reference_id,
        ...
        def wait_for_completion(status, op_result, resource)
          ...
          while status != 'DONE'
            ...
            sleep 1.0
            raise "Invalid result '#{status}' on gcompute_interconnect_attachment." \
